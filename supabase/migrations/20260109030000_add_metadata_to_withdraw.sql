-- This migration adds the missing logic to save withdrawal payment details
-- into the transaction_metadata table.
...
BEGIN
    ...
    -- *** MISSING LOGIC ADDED BACK ***
    -- Insert transaction metadata (key/value) for each payment detail
...
COMMENT ON FUNCTION public.user_withdraw(numeric, text, jsonb) IS 'Processes a withdrawal and correctly saves payment details to transaction_metadata.';
