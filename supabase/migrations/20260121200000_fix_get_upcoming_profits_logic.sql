-- Migration: Fix days_remaining calculation in get_upcoming_profits
-- Date: 2026-01-21
-- Description: Updates get_upcoming_profits to use date differences instead of timestamp intervals for days_remaining.
...
BEGIN
    ...
    SELECT 
        ...
        -- Corrected: Use date subtraction to get calendar days difference
        ((c.start_date + (interval '1 month' * (c.months_paid + 1)))::date - CURRENT_DATE)::INTEGER as days_remaining
