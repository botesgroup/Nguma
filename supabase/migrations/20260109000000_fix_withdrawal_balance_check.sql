-- This migration fixes a check constraint violation in the user_withdraw function
-- by making the balance check and update an atomic operation.
...
COMMENT ON FUNCTION public.user_withdraw(numeric, text, jsonb) IS 'Processes a withdrawal with an atomic balance check.';
