-- Fix Admin Contracts RPC Defaults
-- Redefine admin_list_contracts with defaults for ALL parameters to handle potential missing keys from client.
...
BEGIN
    ...
    -- Handle potential NULLs for required parameters if they were somehow passed as NULL
