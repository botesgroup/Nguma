-- Migration: Corrige la logique de filtrage par statut dans get_investor_list_details
-- Date: 2025-12-12
-- Description: La condition CASE WHEN pour le p_status_filter était logiquement incorrecte.
--              Elle comparait des valeurs booléennes au lieu du statut calculé de l'investisseur.
--              Cette migration corrige la fonction pour qu'elle filtre correctement les investisseurs par leur statut.
