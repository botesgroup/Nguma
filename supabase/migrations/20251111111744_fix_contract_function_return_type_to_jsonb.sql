-- This function allows an admin to get a paginated and searchable list of all contracts.
-- It joins with profiles to include user information.
-- FIX: Changed return type from JSON to JSONB to match internal jsonb functions.
...
DECLARE
    v_offset INT;
    v_contracts JSONB; -- Changed from JSON
