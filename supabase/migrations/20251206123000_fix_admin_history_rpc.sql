-- Migration: Fix RPC for Admin Transaction History (Use first_name/last_name)
-- Date: 2025-12-06
-- Description: Updates get_admin_transaction_history to use first_name and last_name instead of full_name.
...
BEGIN
    ...
    WHERE 
        (p_search_query IS NULL OR 
         ...
         (p.first_name || ' ' || p.last_name) ILIKE '%' || p_search_query || '%' OR
