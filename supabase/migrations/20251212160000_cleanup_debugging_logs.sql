-- Migration: Supprime le log de débogage de la fonction get_investor_list_details.
-- Date: 2025-12-12
-- Description: Cette migration supprime l'instruction `RAISE NOTICE` qui a été ajoutée
--              précédemment pour le débogage de la logique de filtrage par statut.
--              La fonction est restaurée à sa version propre et finale.
