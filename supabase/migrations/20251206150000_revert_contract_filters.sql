-- Revert migration: Drop V2 function and restore original admin_get_all_contracts

-- 1. Drop the V2 function we created
DROP FUNCTION IF EXISTS public.admin_get_contracts_v2(TEXT, TEXT, INT, INT, TEXT, TEXT);

-- 2. Aggressively drop all versions of admin_get_all_contracts to ensure clean slate
DO $$
DECLARE
    func_record RECORD;
BEGIN
...
-- 3. Restore the original function signature (without date filters)
