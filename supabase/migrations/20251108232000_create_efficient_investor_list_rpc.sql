-- This migration creates a new, more efficient RPC function to fetch the investor list.
-- It replaces the client-side N+1 queries with a single server-side query.
-- It also joins with auth.users to get the 'banned_until' status for each user.
