-- Aggressively drop all versions of admin_get_contracts_v2 to ensure no ambiguity
DO $$
DECLARE
    func_record RECORD;
BEGIN
...
-- Recreate the function with TEXT parameters for dates
CREATE OR REPLACE FUNCTION public.admin_get_contracts_v2(
    p_search_query TEXT,
...
BEGIN
    ...
    -- Cast text dates to actual dates if provided
